              ...
              {view === "day" && (
                <button
                  ...
                  className={cn(
                    ...
                    restDaysMap[activePeriod.start]
                ...
                >
                  <Coffee size={12} className={restDaysMap[activePeriod.start] ? "text-indigo-300" : "text-white/40"} />
                  <span>{restDaysMap[activePeriod.start] ? "Rest Day Active ☕" : "Take Rest Day"}</span>
                </button>
              )}
            </div>
