...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::plan::list_plan_templates,
            commands::plan::plan_template_blocks,
            commands::plan::upsert_plan_template,
            commands::plan::delete_plan_template,
            commands::plan::upsert_plan_template_block,
            commands::plan::delete_plan_template_block,
            commands::plan::save_day_as_template,
            commands::plan::suggested_plan_template,
            commands::plan::list_exams,
            ...
            plugins::telegram::tg_retry_stream,
        ])
